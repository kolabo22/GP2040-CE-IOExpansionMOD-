...
// ====================================================================
// 1. 物理ピン（GPIO）の完全固定マッピング（基本アケアカ入力）
// ====================================================================
...
// 機能ボタン (S2/STARTはゲーム中に通常使用する独立ボタンとして100%通常化)
...
// ====================================================================
// 3. 周辺機器・コア通信ブロックの強制ON（手作業ゼロ化マクロ）
// ====================================================================
...
// ====================================================================
// 4. 各種アドオン機能の初期動作設定（リセット時に自動で埋まる項目）
// ====================================================================
// Wii拡張アドオン（ヌンチャク自動連動仕様）
...
#define WII_NUNCHUK_STICK_MODE 1

// 連射アドオン（VRツマミ無段階速度制御 ＆ 同期点滅LED固定）
#define TURBO_ENABLED 1
#define TURBO_PIN 14
#define TURBO_LED_PIN 15
#define TURBO_SHOT_PIN 26

// リアクティブLED（Player LED：押すと消え、離すと光る反転フェードモード）
...
// インデックス14から34個分をケースLED発光エリアとして完全に切り離し
...
#define BUTTON_LAYOUT_RIGHT BUTTON_LAYOUT_VEWLIX // ビューリックス固定

#define SCREEN_SAVER_TIMEOUT 600000
#define SCREEN_SAVER_MODE 2 // 旧式Enum数値の2（雪モード）
#define DISPLAY_MENU_ENABLED 1 

// ====================================================================
// 7. PCF8575 IO エクスパンダー 16ピン入力キーマッピング同期
// ====================================================================
#define PCF8575_ENABLED 1
#define PCF8575_I2C_BLOCK i2c1

// ご提示いただいた16ピン配線表のアクション識別子をマクロレベルで完全ロック
