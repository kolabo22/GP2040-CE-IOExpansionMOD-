...
std::string setAddonOptions()
{
    ...
    // addonOptions 階層を一段掘り下げて取得する
    if (doc.containsKey("addonOptions") && doc["addonOptions"].containsKey("jinglePlayerOptions")) {
        JsonObject jingleObj = doc["addonOptions"]["jinglePlayerOptions"];
