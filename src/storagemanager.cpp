...
static const uint8_t miniSuperPerfectBinary[] = {
	...
	0x08, 0x15, 0x08, 0x16, 0x08, 0x17, 0x08, 0x18, 0x08, 0x19, 0x08, 0x1A, 0x08, 0x10, 0x08, 0x0B, 0x08, 
	0x0C, 0x08, 0x09, 0x08, 0x0D, 0x08, 0x00, 0x08, 0x1B, 0x08, 0x1C, 0x18, 0x10, 0x4A, 0x06, 0x08, 0x01, 
	0x10, 0x02, 0x18, 0x01, 0x52, 0x02, 0x08, 0x01, 0x32, 0x06, 0x08, 0x01, 0x10, 0x01, 0x42, 0x06, 
	0x08, 0x01, 0x10, 0x01
};
...
void Storage::ResetSettings()
{
	...
	// 💡 【修正点】余計な低レイヤ処理をすべて排除し、元々のバニラコードと全く同じ
	// 2000ms（2秒）のディレイ付き再起動に戻します。
	// これにより、システム側が画面に「REBOOTING...」等のロード中の表示を描ききる時間が確保され、
	// 弄る前と全く同じ安心感のある表示ののち、安全に自動再起動がかかります。
