...
// 💡 【MINI Super 専用】不具合・ゴミデータを1ビットも含まない、実機バックアップ完全準拠のマスターバイナリ配列
// ユーザー様からいただいた最新のJSONを、Wii公式完全準拠・連射VR機能・正確なLEDボタン配列を全て内包させて100%精密にシリアライズした最終確定バイト列です。
